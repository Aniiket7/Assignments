...
canvas = Canvas("Result_Aniket-20ce057.pdf")
canvas.drawString(50, 830, "---------------------------------------------Sem 3-------------------------------------- 20CE057")
...
canvas.drawString(50, 660, "CGPA : 9.70")
canvas.drawString(50, 640, "SGPA : 9.79")
canvas.save()
...
canvas = Canvas("Result_Aniket-20ce057.pdf", pagesize=(8.5 * inch, 11 * inch))

from reportlab.lib.pagesizes import LETTER  # noqa

canvas = Canvas("Result_Aniket-20ce057.pdf", pagesize=LETTER)
print(LETTER)
